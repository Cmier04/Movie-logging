(function(global, factory) {
    ...
    async function jwkToKey(jwk) {
        ...
        const _subtleMapping = subtleMapping(jwk), algorithm = _subtleMapping.algorithm, keyUsages = _subtleMapping.keyUsages;
    ...
    var _payload$1 = new WeakMap;
    class JWTClaimsBuilder {
        constructor(payload) {
            _classPrivateFieldInitSpec(this, _payload$1, void 0);
            if (!isObject(payload)) {
                throw new TypeError("JWT Claims Set MUST be an object");
            }
            _classPrivateFieldSet2(_payload$1, this, structuredClone(payload));
        }
        data() {
            return encoder.encode(JSON.stringify(_classPrivateFieldGet2(_payload$1, this)));
        }
        get iss() {
            return _classPrivateFieldGet2(_payload$1, this).iss;
        }
        set iss(value) {
            _classPrivateFieldGet2(_payload$1, this).iss = value;
        }
        get sub() {
            return _classPrivateFieldGet2(_payload$1, this).sub;
        }
        set sub(value) {
            _classPrivateFieldGet2(_payload$1, this).sub = value;
        }
        get aud() {
            return _classPrivateFieldGet2(_payload$1, this).aud;
        }
        set aud(value) {
            _classPrivateFieldGet2(_payload$1, this).aud = value;
        }
        set jti(value) {
            _classPrivateFieldGet2(_payload$1, this).jti = value;
        }
        set nbf(value) {
            if (typeof value === "number") {
                _classPrivateFieldGet2(_payload$1, this).nbf = validateInput("setNotBefore", value);
            } else if (value instanceof Date) {
                _classPrivateFieldGet2(_payload$1, this).nbf = validateInput("setNotBefore", epoch(value));
            } else {
                _classPrivateFieldGet2(_payload$1, this).nbf = epoch(new Date) + secs(value);
            }
        }
        set exp(value) {
            if (typeof value === "number") {
                _classPrivateFieldGet2(_payload$1, this).exp = validateInput("setExpirationTime", value);
            } else if (value instanceof Date) {
                _classPrivateFieldGet2(_payload$1, this).exp = validateInput("setExpirationTime", epoch(value));
            } else {
                _classPrivateFieldGet2(_payload$1, this).exp = epoch(new Date) + secs(value);
            }
        }
        set iat(value) {
            if (value === undefined) {
                _classPrivateFieldGet2(_payload$1, this).iat = epoch(new Date);
            } else if (value instanceof Date) {
                _classPrivateFieldGet2(_payload$1, this).iat = validateInput("setIssuedAt", epoch(value));
            } else if (typeof value === "string") {
                _classPrivateFieldGet2(_payload$1, this).iat = validateInput("setIssuedAt", epoch(new Date) + secs(value));
            } else {
                _classPrivateFieldGet2(_payload$1, this).iat = validateInput("setIssuedAt", value);
            }
        }
    }
    ...
    var _payload = new WeakMap;
    var _protectedHeader$1 = new WeakMap;
    var _unprotectedHeader = new WeakMap;
    class FlattenedSign {
        constructor(payload) {
            _classPrivateFieldInitSpec(this, _payload, void 0);
            _classPrivateFieldInitSpec(this, _protectedHeader$1, void 0);
            _classPrivateFieldInitSpec(this, _unprotectedHeader, void 0);
            if (!(payload instanceof Uint8Array)) {
                throw new TypeError("payload must be an instance of Uint8Array");
            }
            _classPrivateFieldSet2(_payload, this, payload);
        }
        setProtectedHeader(protectedHeader) {
            assertNotSet(_classPrivateFieldGet2(_protectedHeader$1, this), "setProtectedHeader");
            _classPrivateFieldSet2(_protectedHeader$1, this, protectedHeader);
            return this;
        }
        setUnprotectedHeader(unprotectedHeader) {
            assertNotSet(_classPrivateFieldGet2(_unprotectedHeader, this), "setUnprotectedHeader");
            _classPrivateFieldSet2(_unprotectedHeader, this, unprotectedHeader);
            return this;
        }
        async sign(key, options) {
            if (!_classPrivateFieldGet2(_protectedHeader$1, this) && !_classPrivateFieldGet2(_unprotectedHeader, this)) {
                throw new JWSInvalid("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
            }
            if (!isDisjoint(_classPrivateFieldGet2(_protectedHeader$1, this), _classPrivateFieldGet2(_unprotectedHeader, this))) {
                throw new JWSInvalid("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
            }
            const joseHeader = _objectSpread2(_objectSpread2({}, _classPrivateFieldGet2(_protectedHeader$1, this)), _classPrivateFieldGet2(_unprotectedHeader, this));
            const extensions = validateCrit(JWSInvalid, new Map([ [ "b64", true ] ]), options === null || options === void 0 ? void 0 : options.crit, _classPrivateFieldGet2(_protectedHeader$1, this), joseHeader);
            let b64 = true;
            if (extensions.has("b64")) {
                b64 = _classPrivateFieldGet2(_protectedHeader$1, this).b64;
                if (typeof b64 !== "boolean") {
                    throw new JWSInvalid('The "b64" (base64url-encode payload) Header Parameter must be a boolean');
                }
            }
            ...
            let payloadB;
            if (b64) {
                payloadS = encode(_classPrivateFieldGet2(_payload, this));
                payloadB = encode$1(payloadS);
            } else {
                payloadB = _classPrivateFieldGet2(_payload, this);
                payloadS = "";
            }
            let protectedHeaderString;
            let protectedHeaderBytes;
            if (_classPrivateFieldGet2(_protectedHeader$1, this)) {
                protectedHeaderString = encode(JSON.stringify(_classPrivateFieldGet2(_protectedHeader$1, this)));
            ...
            if (_classPrivateFieldGet2(_unprotectedHeader, this)) {
                jws.header = _classPrivateFieldGet2(_unprotectedHeader, this);
            }
            if (_classPrivateFieldGet2(_protectedHeader$1, this)) {
    ...
    var _flattened = new WeakMap;
    class CompactSign {
        constructor(payload) {
            _classPrivateFieldInitSpec(this, _flattened, void 0);
            _classPrivateFieldSet2(_flattened, this, new FlattenedSign(payload));
        }
        setProtectedHeader(protectedHeader) {
            _classPrivateFieldGet2(_flattened, this).setProtectedHeader(protectedHeader);
            return this;
        }
        async sign(key, options) {
            const jws = await _classPrivateFieldGet2(_flattened, this).sign(key, options);
            if (jws.payload === undefined) {
    ...
    var _jwt = new WeakMap;
    class SignJWT {
        constructor() {
            let payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            _classPrivateFieldInitSpec(this, _protectedHeader, void 0);
            _classPrivateFieldInitSpec(this, _jwt, void 0);
            _classPrivateFieldSet2(_jwt, this, new JWTClaimsBuilder(payload));
        }
        setIssuer(issuer) {
            _classPrivateFieldGet2(_jwt, this).iss = issuer;
            return this;
        }
        setSubject(subject) {
            _classPrivateFieldGet2(_jwt, this).sub = subject;
            return this;
        }
        setAudience(audience) {
            _classPrivateFieldGet2(_jwt, this).aud = audience;
            return this;
        }
        setJti(jwtId) {
            _classPrivateFieldGet2(_jwt, this).jti = jwtId;
            return this;
        }
        setNotBefore(input) {
            _classPrivateFieldGet2(_jwt, this).nbf = input;
            return this;
        }
        setExpirationTime(input) {
            _classPrivateFieldGet2(_jwt, this).exp = input;
            return this;
        }
        setIssuedAt(input) {
            _classPrivateFieldGet2(_jwt, this).iat = input;
            return this;
        }
        setProtectedHeader(protectedHeader) {
        ...
        async sign(key, options) {
            ...
            const sig = new CompactSign(_classPrivateFieldGet2(_jwt, this).data());
            sig.setProtectedHeader(_classPrivateFieldGet2(_protectedHeader, this));
            if (Array.isArray((_classPrivateFieldGet2$1 = _classPrivateFieldGet2(_protectedHeader, this)) === null || _classPrivateFieldGet2$1 === void 0 ? void 0 : _classPrivateFieldGet2$1.crit) && _classPrivateFieldGet2(_protectedHeader, this).crit.includes("b64") && _classPrivateFieldGet2(_protectedHeader, this).b64 === false) {
                throw new JWTInvalid("JWTs MUST NOT use unencoded payload");
            }
    ...
    var _baseUrl, _clientId, _clientSecret, _customFetch, _getConfiguration, _baseUrl2, _clientId2, _customFetch2, _grantRequest, _Class0_brand, _baseUrl3, _domain, _clientId3, _customFetch3, _clientAuthOptions, _grantRequest2, _Class11_brand, _baseUrl4, _clientId4, _customFetch4, _Class13_brand, _entries, _ttlMs, _maxEntries, _configuration, _serverMetadata, _clientAuthPromise, _options, _customFetch5, _jwks, _discoveryCache, _inFlightDiscovery, _jwksCache, _Class15_brand;
    ...
    _customFetch = new WeakMap, _getConfiguration = new WeakMap, class MfaClient {
        constructor(options) {
        ...
        async verify(options) {
            ...
            const configuration = await _classPrivateFieldGet2(_getConfiguration, this).call(this);
            const params = {
            ...
            try {
                ...
                var _err$error2, _ref3, _err$error_descriptio2;
                if (e instanceof MfaVerifyError$1) {
                    throw e;
                }
                const err = e;
                throw new MfaVerifyError$1(err.error_description || err.message || "Failed to verify MFA challenge", {
                    error: (_err$error2 = err.error) !== null && _err$error2 !== void 0 ? _err$error2 : "mfa_verify_error",
                    error_description: (_ref3 = (_err$error_descriptio2 = err.error_description) !== null && _err$error_descriptio2 !== void 0 ? _err$error_descriptio2 : err.message) !== null && _ref3 !== void 0 ? _ref3 : "Failed to verify MFA challenge"
                });
            }
        }
    });
    ...
    var PasskeyClient = (_baseUrl2 = new WeakMap, _clientId2 = new WeakMap, _customFetch2 = new WeakMap, 
    _grantRequest = new WeakMap, _Class0_brand = new WeakSet, class PasskeyClient {
        constructor(options) {
            var _options$customFetch2;
        ...
        async register(options) {
            ...
            const response = await _classPrivateFieldGet2(_customFetch2, this).call(this, url, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            if (!response.ok) {
                const error = await _assertClassBrand(_Class0_brand, this, _parseErrorResponse).call(this, response);
        ...
        async getTokenByPasskey(options) {
            ...
            let tokenResponse;
            try {
                tokenResponse = await _classPrivateFieldGet2(_grantRequest, this).call(this, PASSKEY_GRANT_TYPE, params);
            } catch (e) {
                const apiError = toOAuth2Error(e);
                throw new PasskeyGetTokenError(apiError.error_description || "Failed to exchange passkey credential for tokens.", apiError);
            }
            if (options.organization) {
    ...
    _customFetch3 = new WeakMap, _clientAuthOptions = new WeakMap, _grantRequest2 = new WeakMap, 
    _Class11_brand = new WeakSet, class PasswordlessClient {
        constructor(options) {
            var _options$customFetch3;
            _classPrivateMethodInitSpec(this, _Class11_brand);
        ...
        async sendEmail(options) {
            await _assertClassBrand(_Class11_brand, this, _start).call(this, transformSendEmailRequest(options), "Failed to send passwordless email", options.language);
        }
        async sendSms(options) {
            ...
            await _assertClassBrand(_Class11_brand, this, _start).call(this, transformSendSmsRequest(options), "Failed to send passwordless SMS", options.language);
        }
        async challengeWithEmail(options) {
            const wireBody = transformChallengeEmailRequest(options);
            return _assertClassBrand(_Class11_brand, this, _challenge).call(this, wireBody, "Failed to request email OTP challenge");
        }
        async challengeWithPhoneNumber(options) {
            ...
            return _assertClassBrand(_Class11_brand, this, _challenge).call(this, wireBody, "Failed to request phone OTP challenge");
        }
        async getTokenByPasswordlessDbConnection(options) {
            ...
            try {
                return await _classPrivateFieldGet2(_grantRequest2, this).call(this, PASSWORDLESS_OTP_GRANT_TYPE, params);
            } catch (e) {
                throw new PasswordlessDbGetTokenError("There was an error while trying to request a token.", toOAuth2Error(e));
            }
        }
    });
    async function _start(wireBody, failureMessage, language) {
        var _errorBody;
        const clientAuthBody = await buildClientAuthBody(_classPrivateFieldGet2(_clientAuthOptions, this), _classPrivateFieldGet2(_clientId3, this), _classPrivateFieldGet2(_domain, this));
        const finalBody = _objectSpread2(_objectSpread2({
            client_id: _classPrivateFieldGet2(_clientId3, this)
        }, wireBody), clientAuthBody);
        let response;
        try {
            response = await _classPrivateFieldGet2(_customFetch3, this).call(this, "".concat(_classPrivateFieldGet2(_baseUrl3, this), "/passwordless/start"), {
                method: "POST",
        ...
        throw new PasswordlessStartError(((_errorBody = errorBody) === null || _errorBody === void 0 ? void 0 : _errorBody.error_description) || failureMessage, errorBody);
    }
    async function _challenge(wireBody, failureMessage) {
        ...
        let response;
        try {
            response = await _classPrivateFieldGet2(_customFetch3, this).call(this, "".concat(_classPrivateFieldGet2(_baseUrl3, this), "/otp/challenge"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
        ...
        if (response.ok) {
            ...
            try {
                ...
                throw new PasswordlessChallengeError("".concat(failureMessage, ": could not parse the response body."), response.status, void 0, void 0);
            }
            return {
        ...
        throw new PasswordlessChallengeError(((_errorBody2 = errorBody) === null || _errorBody2 === void 0 ? void 0 : _errorBody2.error_description) || failureMessage, response.status, errorBody, (_errorBody3 = errorBody) === null || _errorBody3 === void 0 ? void 0 : _errorBody3.validation_errors);
    }
    ...
    function normalizeSignUpResult(raw) {
        var _ref4, _raw$_id;
        const id = (_ref4 = (_raw$_id = raw._id) !== null && _raw$_id !== void 0 ? _raw$_id : raw.user_id) !== null && _ref4 !== void 0 ? _ref4 : raw.id;
        return {
            id: id,
    ...
    _Class13_brand = new WeakSet, class DatabaseClient {
        constructor(options) {
            var _options$customFetch4;
        ...
        async signUp(options) {
            ...
            const response = await _assertClassBrand(_Class13_brand, this, _post).call(this, "/dbconnections/signup", body, SignUpError, "Failed to sign up");
        ...
        async changePassword(options) {
            ...
            const response = await _assertClassBrand(_Class13_brand, this, _post).call(this, "/dbconnections/change_password", body, ChangePasswordError, "Failed to request a password change");
            return response.text();
        }
    });
    async function _post(path, body, ErrorClass, failureMessage) {
        let response;
        try {
            response = await _classPrivateFieldGet2(_customFetch4, this).call(this, "".concat(_classPrivateFieldGet2(_baseUrl4, this)).concat(path), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
        ...
        throw new ErrorClass((errorBody === null || errorBody === void 0 ? void 0 : errorBody.error_description) || failureMessage, errorBody);
    }
    ...
    function getTelemetryConfig(config) {
        ...
        return {
            ...
            version: (_config$version = config === null || config === void 0 ? void 0 : config.version) !== null && _config$version !== void 0 ? _config$version : "1.12.0"
        };
    }
    ...
    function appendExtraParams(params, extra) {
        if (!extra) return;
        for (const _ref5 of Object.entries(extra)) {
            var _ref6 = _slicedToArray(_ref5, 2);
            const parameterKey = _ref6[0];
            const parameterValue = _ref6[1];
    ...
    function createPasskeyFetch(customFetch3, grantType) {
        return (input, init) => {
            ...
            return customFetch3(input, _objectSpread2(_objectSpread2({}, init), {}, {
                headers: headers,
    ...
    _options = new WeakMap, _customFetch5 = new WeakMap, _jwks = new WeakMap, _discoveryCache = new WeakMap, 
    _inFlightDiscovery = new WeakMap, _jwksCache = new WeakMap, _Class15_brand = new WeakSet, 
    class AuthClient {
        constructor(_options2) {
            ...
            _classPrivateFieldSet2(_customFetch5, this, createTelemetryFetch((_options2$customFetch = _options2.customFetch) !== null && _options2$customFetch !== void 0 ? _options2$customFetch : function() {
                return fetch(...arguments);
            ...
            this.mfa = new MfaClient({
                ...
                clientSecret: _classPrivateFieldGet2(_options, this).clientSecret,
                customFetch: _classPrivateFieldGet2(_customFetch5, this),
                getConfiguration: async () => (await _assertClassBrand(_Class15_brand, this, _discover).call(this)).configuration
            });
            this.passkey = new PasskeyClient({
                ...
                grantRequest: async (grantType, params) => {
                    const _await$_assertClassBr = await _assertClassBrand(_Class15_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr.serverMetadata;
                    const configuration = await _assertClassBrand(_Class15_brand, this, _createConfiguration).call(this, serverMetadata);
                    configuration[customFetch$1] = createPasskeyFetch(_classPrivateFieldGet2(_customFetch5, this), grantType);
            ...
            this.passwordless = new PasswordlessClient({
                ...
                customFetch: _classPrivateFieldGet2(_customFetch5, this),
                clientSecret: _classPrivateFieldGet2(_options, this).clientSecret,
                clientAssertionSigningKey: _classPrivateFieldGet2(_options, this).clientAssertionSigningKey,
                clientAssertionSigningAlg: _classPrivateFieldGet2(_options, this).clientAssertionSigningAlg,
                useMtls: _classPrivateFieldGet2(_options, this).useMtls,
                grantRequest: async (grantType, params) => {
                    const _await$_assertClassBr2 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr2.configuration;
                    const tokenEndpointResponse = await genericGrantRequest(configuration, grantType, params);
                    return TokenResponse.fromTokenEndpointResponse(tokenEndpointResponse);
                }
            });
        ...
        async getServerMetadata() {
            const _await$_assertClassBr3 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr3.serverMetadata;
            return serverMetadata;
        }
        async buildAuthorizationUrl(options) {
            const _await$_assertClassBr4 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr4.serverMetadata;
            ...
            try {
                return await _assertClassBrand(_Class15_brand, this, _buildAuthorizationUrl).call(this, options);
            } catch (e) {
        ...
        async buildLinkUserUrl(options) {
            try {
                const result = await _assertClassBrand(_Class15_brand, this, _buildAuthorizationUrl).call(this, {
        ...
        async backchannelAuthentication(options) {
            const _await$_assertClassBr5 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr5.configuration, serverMetadata = _await$_assertClassBr5.serverMetadata;
        ...
        async initiateBackchannelAuthentication(options) {
            const _await$_assertClassBr6 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr6.configuration, serverMetadata = _await$_assertClassBr6.serverMetadata;
            const additionalParams = stripUndefinedProperties(_objectSpread2(_objectSpread2({}, _classPrivateFieldGet2(_options, this).authorizationParams), options === null || options === void 0 ? void 0 : options.authorizationParams));
            const params = new URLSearchParams(_objectSpread2(_objectSpread2({
                scope: DEFAULT_SCOPES
            }, additionalParams), {}, {
        ...
        async backchannelAuthenticationGrant(_ref9) {
            let authReqId = _ref9.authReqId;
            const _await$_assertClassBr7 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr7.configuration;
            const params = new URLSearchParams({
        ...
        async exchangeToken(options) {
            return "connection" in options ? _assertClassBrand(_Class15_brand, this, _exchangeTokenVaultToken).call(this, options) : _assertClassBrand(_Class15_brand, this, _exchangeProfileToken).call(this, options);
        }
        async getTokenByCode(url, options) {
            const _await$_assertClassBr8 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr8.configuration;
            if (options.organization !== void 0) {
                assertValidOrganization(options.organization);
            }
            let tokenResponse;
        ...
        async getTokenByMagicLinkCode(url, options) {
            const _await$_assertClassBr9 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr9.configuration;
            try {
                const tokenEndpointResponse = await authorizationCodeGrant(configuration, url, {
        ...
        async getTokenByRefreshToken(options) {
            const _await$_assertClassBr0 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr0.configuration;
            ...
            try {
                ...
                throw new TokenByRefreshTokenError("The access token has expired and there was an error while trying to refresh it.", toOAuth2Error(e));
            }
        }
        async revokeToken(options) {
            const _await$_assertClassBr1 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr1.configuration;
            const params = {};
            if (options.tokenTypeHint) {
                params["token_type_hint"] = options.tokenTypeHint;
            }
            try {
                await tokenRevocation(configuration, options.token, params);
            } catch (e) {
                throw new TokenRevocationError("An error occurred while trying to revoke the token.", toOAuth2Error(e));
            }
        }
        async getTokenByPassword(options) {
            const _await$_assertClassBr10 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr10.configuration;
            const params = new URLSearchParams({
                username: options.username,
                password: options.password
            });
            ...
            if (options.auth0ForwardedFor) {
                const clientAuth = await _assertClassBrand(_Class15_brand, this, _getClientAuth).call(this);
                ...
                requestConfig[customFetch$1] = (url, init) => _classPrivateFieldGet2(_customFetch5, this).call(this, url, _objectSpread2(_objectSpread2({}, init), {}, {
        ...
        async getTokenByPasswordlessEmail(options) {
            ...
            return _assertClassBrand(_Class15_brand, this, _getTokenByPasswordlessOtp).call(this, params);
        }
        ...
        async getTokenByClientCredentials(options) {
            const _await$_assertClassBr11 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr11.configuration;
            try {
                const params = new URLSearchParams({
        ...
        async buildLogoutUrl(options) {
            const _await$_assertClassBr12 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr12.configuration, serverMetadata = _await$_assertClassBr12.serverMetadata;
        ...
        async verifyLogoutToken(options) {
            const _await$_assertClassBr13 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr13.serverMetadata;
    ...
    async function _createConfiguration(serverMetadata) {
        ...
        configuration[customFetch$1] = _classPrivateFieldGet2(_customFetch5, this);
    ...
    async function _discover() {
        ...
        const cacheKey = _assertClassBrand(_Class15_brand, this, _getDiscoveryCacheKey).call(this);
        ...
        if (cached) {
            ...
            _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class15_brand, this, _createConfiguration).call(this, cached.serverMetadata));
            return {
                configuration: _classPrivateFieldGet2(_configuration, this),
                serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
            };
        ...
        if (inFlight) {
            ...
            _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class15_brand, this, _createConfiguration).call(this, entry.serverMetadata));
            return {
                configuration: _classPrivateFieldGet2(_configuration, this),
                serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
            };
        ...
        const discoveryPromise = (async () => {
            ...
            const configuration = await discovery(new URL("https://".concat(_classPrivateFieldGet2(_options, this).domain)), _classPrivateFieldGet2(_options, this).clientId, {
                ...
                [customFetch$1]: _classPrivateFieldGet2(_customFetch5, this)
            });
        ...
        const inFlightEntry = discoveryPromise.then(_ref0 => {
            let serverMetadata = _ref0.serverMetadata;
            return {
                serverMetadata: serverMetadata
            };
        });
        ...
        try {
            const _await$discoveryPromi = await discoveryPromise, configuration = _await$discoveryPromi.configuration, serverMetadata = _await$discoveryPromi.serverMetadata;
            _classPrivateFieldSet2(_configuration, this, configuration);
            _classPrivateFieldSet2(_serverMetadata, this, serverMetadata);
            _classPrivateFieldGet2(_configuration, this)[customFetch$1] = _classPrivateFieldGet2(_customFetch5, this);
        } finally {
    ...
    async function _exchangeTokenVaultToken(options) {
        ...
        const _await$_assertClassBr14 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr14.configuration;
        ...
        try {
            ...
            throw new TokenExchangeError("Failed to exchange token for connection '".concat(options.connection, "'."), toOAuth2Error(e));
        }
    }
    async function _exchangeProfileToken(options) {
        const _await$_assertClassBr15 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr15.configuration;
        validateSubjectToken(options.subjectToken);
        if (options.organization !== void 0) {
            assertValidOrganization(options.organization);
        }
        ...
        try {
            tokenEndpointResponse = await genericGrantRequest(configuration, TOKEN_EXCHANGE_GRANT_TYPE, tokenRequestParams);
            tokenResponse = TokenResponse.fromTokenEndpointResponse(tokenEndpointResponse);
        } catch (e) {
            throw new TokenExchangeError("Failed to exchange token of type '".concat(options.subjectTokenType, "'").concat(options.audience ? " for audience '".concat(options.audience, "'") : "", "."), toOAuth2Error(e));
        }
        if (options.organization) {
            validateOrganizationClaim(tokenResponse.claims, options.organization);
        }
    ...
    async function _getTokenByPasswordlessOtp(params) {
        const _await$_assertClassBr16 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr16.configuration;
        try {
            const tokenEndpointResponse = await genericGrantRequest(configuration, "http://auth0.com/oauth/grant-type/passwordless/otp", params);
            return TokenResponse.fromTokenEndpointResponse(tokenEndpointResponse);
        } catch (e) {
    ...
    async function _buildAuthorizationUrl(options) {
        const _await$_assertClassBr17 = await _assertClassBrand(_Class15_brand, this, _discover).call(this), configuration = _await$_assertClassBr17.configuration;
    ...
    class Auth0Client {
        ...
        async logout() {
            let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            const _a = patchOpenUrlWithOnRedirect(options), openUrl = _a.openUrl, logoutOptions = __rest(_a, [ "openUrl" ]);
        ...
        async _getTokenUsingRefreshToken(options) {
            ...
            try {
                ...
                if (!this.onlineAccess && tokenResult.refresh_token && (cache === null || cache === void 0 ? void 0 : cache.refresh_token)) {
